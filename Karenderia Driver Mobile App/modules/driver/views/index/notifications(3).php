 ...
 <div class="content_main">
  ...
  ?>  
   ...
   <tbody>
     ...
     <tr>
     <td><?php echo t("NEW_ADDED_DRIVER")?></td>
     <td>
     <?php echo CHtml::checkBox('NEW_DRIVER_PUSH', 
     getOptionA("NEW_DRIVER_PUSH")==1?true:false
      ,array('class'=>"switch-boostrap",'disabled'=>true))?>
     </td>
     <td>
     <?php echo CHtml::checkBox('NEW_DRIVER_SMS', 
     getOptionA("NEW_DRIVER_SMS")==1?true:false
      ,array('class'=>"switch-boostrap"      
      ))?>
     </td>
     <td>
     <?php echo CHtml::checkBox('NEW_DRIVER_EMAIL', 
     getOptionA("NEW_DRIVER_EMAIL")==1?true:false
      ,array('class'=>"switch-boostrap"))?>
     </td>     
     ...
     <tr>
     <td><?php echo t("NEW_SIGNUP_WELCOME")?></td>
     <td>
     <?php echo CHtml::checkBox('DRIVER_NEW_SIGNUP_PUSH', 
     getOptionA("DRIVER_NEW_SIGNUP_PUSH")==1?true:false
      ,array('class'=>"switch-boostrap",'disabled'=>true))?>
     </td>
     <td>
     <?php echo CHtml::checkBox('DRIVER_NEW_SIGNUP_SMS', 
     getOptionA("DRIVER_NEW_SIGNUP_SMS")==1?true:false
      ,array('class'=>"switch-boostrap",'disabled'=>true      
      ))?>
     </td>
     <td>
     <?php echo CHtml::checkBox('DRIVER_NEW_SIGNUP_EMAIL', 
     getOptionA("DRIVER_NEW_SIGNUP_EMAIL")==1?true:false
      ,array('class'=>"switch-boostrap"))?>
     </td>     
     ...
     <tr>
     <td><?php echo t("SIGNUP_APPROVED")?></td>
     <td>
     <?php echo CHtml::checkBox('SIGNUP_APPROVED_PUSH', 
     getOptionA("SIGNUP_APPROVED_PUSH")==1?true:false
      ,array('class'=>"switch-boostrap",'disabled'=>true))?>
     </td>
     <td>
     <?php echo CHtml::checkBox('SIGNUP_APPROVED_SMS', 
     getOptionA("SIGNUP_APPROVED_SMS")==1?true:false
      ,array('class'=>"switch-boostrap"
      ))?>
     </td>
     <td>
     <?php echo CHtml::checkBox('SIGNUP_APPROVED_EMAIL', 
     getOptionA("SIGNUP_APPROVED_EMAIL")==1?true:false
      ,array('class'=>"switch-boostrap"))?>
     </td>     
     <td><a href="javascript:;" class="notification_tpl" data-id="SIGNUP_APPROVED"><i class="ion-edit"></i></a></td>
      ...
      <tr>
     <td><?php echo t("SIGNUP_DENIED")?></td>
     <td>
     <?php echo CHtml::checkBox('SIGNUP_DENIED_PUSH', 
     getOptionA("SIGNUP_DENIED_PUSH")==1?true:false
      ,array('class'=>"switch-boostrap",'disabled'=>true))?>
     </td>
     <td>
     <?php echo CHtml::checkBox('SIGNUP_DENIED_SMS', 
     getOptionA("SIGNUP_DENIED_SMS")==1?true:false
      ,array('class'=>"switch-boostrap"
      ))?>
     </td>
     <td>
     <?php echo CHtml::checkBox('SIGNUP_DENIED_EMAIL', 
     getOptionA("SIGNUP_DENIED_EMAIL")==1?true:false
      ,array('class'=>"switch-boostrap"))?>
     </td>     
